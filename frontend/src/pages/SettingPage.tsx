...
// export default function SettingPage({ onClose }: Props) {
//     // draft (user editing)
...
//                                 value={draftTag}
//                                 onChange={(e) => {
//                                     const value = e.target.value as "span" | "div";
//                                     setDraftTag(value);
//                                     setTag(value);        // 🔥 auto apply
//                                 }}
...
//                                 <option value="span" className="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">&lt;span&gt; · inline</option>
//                                 <option value="div" className="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">&lt;div&gt; · block</option>
//                             </select> */}
...
//                                     setDraftClass(value);
//                                     setCssClass(value.trim());   // 🔥 auto apply
//                                 }}
...
//                             {`<wbr><${tag}${cssClass ? ` class="${cssClass}"` : ""}>
//   ประสิทธิภาพ
// </${tag}>…`}
//                         </pre>
//                     </div>
